...
class ExoticStyleUserRegistration extends Component {
    ...
    submitAddUserForm = (e) => {
        ...
        this.setState({notice:'Account Created! Please login!'})
            ...
            <div>
                ...
                <form onSubmit={this.submitAddUserForm}>
                    <p>
                        ...
                        <input id={"id"} type="text" name='id' placeholder="Enter user ID" autoFocus/>
                    </p>
                    <p>
...
export default ExoticStyleUserRegistration;